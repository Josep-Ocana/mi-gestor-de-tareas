    ...
    <header className="sticky top-0 z-20 border-b border-border/40 bg-main-bg px-4 py-3 sm:px-6">
      <div className="mx-auto grid max-w-7xl grid-cols-[1fr_auto] items-center gap-3 lg:grid-cols-[1fr_auto_1fr]">
        ...
        <nav
          ...
          className="order-3 col-span-2 mx-auto flex w-full max-w-md items-center justify-center rounded-xl border border-border/40 bg-card-bg p-1 lg:order-0 lg:col-span-1"
        >
          <NavLink
            to={"/tasks"}
            className={({ isActive }) =>
        ...
        <div className="flex min-w-0 items-center justify-end gap-2 sm:gap-3">
          <ThemeToggle />
          <div className="hidden min-w-0 items-center gap-2 rounded-xl border border-border/40 bg-card-bg px-2.5 py-1.5 sm:flex">
